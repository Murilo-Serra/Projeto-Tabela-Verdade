while True:
    qntProp = int(input("Insira a quantidade de proposicões que serão utilizadas (qnt. letras, max 5, min 2): "))
    if 6 > qntProp > 1:
        break
    else:
...
while "$" in userInputList:
    for i in range(len(userInputList)):
        ...
        elif userInputList[i] == "n" and userInputList[i+1] == "(" and userInputList[i+3] == ")":
            userInputList[i] = notx(userInputList[i+2])

            userInputList[i+1] = ""
            userInputList[i+2] = ""
            userInputList[i+3] = ""

        elif userInputList[i] == "(" and userInputList[i+2] == ")":
            userInputList[i] = ""
            userInputList[i+2] = ""
...
while "n" in userInputList:
    for i in range(len(userInputList)):
        if userInputList[i] == "n" and userInputList[i + 1] == "(" and userInputList[i + 3] == ")":
            userInputList[i] = notx(userInputList[i + 2])
